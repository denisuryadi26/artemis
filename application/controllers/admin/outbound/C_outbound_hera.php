...
class C_outbound_hera extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model("outbound/M_outbound_hera");
    }
	...
	public function index()
	{
        ...
        $nilaislaweekindomall = array();
        $nilaislaweekindomall[] = array(
            "program_name"  => "Toko Cabang",
            "location_name" => "None",
            "ach_packed"    => "-",
            "color_packed"  => "",
            "ach_rts"       => "-",
        ...
        $nilaisladayindomall = array();
        $nilaisladayindomall[] = array(
            "program_name"         => "INDONESIA MALL",
            "location_id"          => "",
            "location_name"        => "NONE",
        ...
        $data['nilaislaweekindomall'] = json_decode(json_encode($nilaislaweekindomall));
        $data['nilaisladayindomall'] = json_decode(json_encode($nilaisladayindomall));
        $data['nilaislaweekhera'] = json_decode(json_encode($nilaislaweekhera));
        $data['nilaisladayhera'] = json_decode(json_encode($nilaisladayhera));
        // $data['nilaislaweekhera']     = $this->M_outbound_hera->getslaweekhera(date('M Y'));
        // $data['nilaislaweekindomall'] = $this->M_outbound_hera->getslaweekindomall(date('M Y'));
        // $data['nilaisladayhera']      = $this->M_outbound_hera->getsladayhera(date('M Y'));
        // $data['nilaisladayindomall']  = $this->M_outbound_hera->getsladayindomall(date('M Y'));

		$data['title'] = 'Performance';
		$this->load->view('admin/layout/v_head',$data);
		$this->load->view('admin/layout/v_header');
		$this->load->view('admin/layout/v_nav',$data);
		$this->load->view('admin/dashboard/outbound/v_outbound_hera',$data);
        $this->load->view('admin/layout/v_footer');

    }

    public function getIndoMallSum()
    {
    ...
    public function getIndoMallDay()
    {
        $params = json_decode(file_get_contents('php://input'),true); 
