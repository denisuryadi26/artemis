...
class C_inbound_tokocabang extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model("inbound/M_inbound_tokocabang");
    }
	...
	public function index()
	{
        ...
        $this->load->view('admin/dashboard/inbound/v_inbound_tokocabang',$data);
    ...
    public function getAllslaTokocabang()
    {
        ...
        $data['nilaislatokocabang']    = $this->M_inbound_tokocabang->getslaweektokocabang(date('M Y'));
        // $data['nilaisladaytokocabang'] = $this->M_inbound_tokocabang->getsladaytokocabang(date('M Y'));
