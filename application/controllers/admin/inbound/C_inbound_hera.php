...
class C_inbound_hera extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model("inbound/M_inbound_hera");
    }
	...
	public function index()
	{
        ...
        // $data['nilaislaweekhera']     = $this->M_inbound_hera->getslaweekhera(date('M Y'));
        // $data['nilaislaweekindomall'] = $this->M_inbound_hera->getslaweekindomall(date('M Y'));
        // $data['nilaisladayhera']      = $this->M_inbound_hera->getsladayhera(date('M Y'));
        // $data['nilaisladayindomall']  = $this->M_inbound_hera->getsladayindomall(date('M Y'));

		$data['title'] = 'Performance';
		$this->load->view('admin/layout/v_head',$data);
		$this->load->view('admin/layout/v_header');
		$this->load->view('admin/layout/v_nav',$data);
		$this->load->view('admin/dashboard/inbound/v_inbound_hera',$data);
