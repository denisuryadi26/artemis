...
class C_inbound_clientinternal extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model("inbound/M_inbound_clientinternal");
    }
	...
	public function index()
	{
        ...
        // $data['nilaiqueryslatopclient']    = $this->M_inbound_clientinternal->getslaweekclient(date('M Y'));
        // $data['nilaiquerysladaytopclient'] = $this->M_inbound_clientinternal->getsladayclient(date('M Y'));

		$data['title'] = 'Performance';
		$this->load->view('admin/layout/v_head',$data);
		$this->load->view('admin/layout/v_header');
		$this->load->view('admin/layout/v_nav',$data);
		$this->load->view('admin/dashboard/inbound/v_inbound_clientinternal',$data);
    ...
    public function getSlaTopClient()
    {
        ...
        $nilaislatopclient = $this->M_inbound_clientinternal->getslatopclient($date, $allclient);
