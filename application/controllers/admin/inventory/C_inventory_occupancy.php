...
class C_inventory_occupancy extends CI_Controller {
	...
	public function __construct()
    {
        ...
        $this->load->model("inventory/M_inventory_occupancy");
    }
	...
	public function index()
	{
		...
		$data['emptyinventory'] = $this->M_inventory_occupancy->emptyinventory();
        $data['title'] = 'Empty Inventory';
		$this->load->view('admin/layout/v_head',$data);
		$this->load->view('admin/layout/v_header');
		$this->load->view('admin/layout/v_nav',$data);
		$this->load->view('admin/dashboard/inventory/v_inventory_occupancy',$data);
