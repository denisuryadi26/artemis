        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <section class="content">
                            <form id="inbound-form" action="<?php echo base_url("admin/reportinglist/C_stockmovement/export"); ?>" method="post">
                                <div class="box box-solid box-primary">
                                    <!-- <div class="box-header with-border">
                                        <i class="fa fa-file-o"></i>
                                        <h3 class="box-title">STOCK MOVEMENT INFORMATION</h3>
                                    </div> -->
                                    <div class="card card-lightblue">
                                        <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-list"></i> STOCK MOVEMENT INFORMATION</h3>
                                        </div>
                                    </div>
                                    <div class="box-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <!-- <div class="form-group col-md-6">
                                                <input id="ytReporting_all_client" type="hidden" value="0" name="Reporting[all_client]" />
                                                <input name="Reporting[all_client]" id="Reporting_all_client" value="1" type="checkbox" /> ALL CLIENT
                                            </div>
                                            <div class="form-group col-md-6">
                                                <input id="ytReporting_all_location" type="hidden" value="0" name="Reporting[all_location]" />
                                                <input name="Reporting[all_location]" id="Reporting_all_location" value="1" type="checkbox" /> ALL LOCATION
                                            </div> -->
