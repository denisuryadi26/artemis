        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <section class="content">
                            <form id="inbound-form" action="<?php echo base_url("admin/reportinglist/C_stockitem/export"); ?>" method="post">
                                <div class="box box-solid box-info">
                                    <div class="card card-info">
                                        <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-list"></i> STOCK BASED ON ITEM INFORMATION</h3>
                                        </div>
                                    </div>
                                    <div class="box-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" size="60" maxlength="200" placeholder="MARKET PLACE" name="marketplace" id="Reporting_market_place" type="text" /> </div>
                                        </div>
                                        <div class="row">
                                            <!-- <div class="form-group col-md-6">
