        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <!-- <div class="card-body">
                        <section class="content-header">
                            ...
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">stock daily</li>
                            </ol>
                            <h1>
                                    <div class="btn-group">
                    ...
                    <div class="card-body">
                        <section class="content">
                            <form id="inbound-form" action="<?php echo base_url("admin/reportinglist/C_stockdaily/export"); ?>" method="post">
                                <div class="box box-solid box-primary">
                                    <!-- <div class="box-header with-border">
                                        <i class="fa fa-file-o"></i>
                                        <h3 class="box-title">DUMP INVENTORY INFORMATION</h3>
                                    </div> -->
                                    <div class="card card-lightblue">
                                        <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-list"></i> DUMP INVENTORY INFORMATION</h3>
                                        </div>
                                    </div>
