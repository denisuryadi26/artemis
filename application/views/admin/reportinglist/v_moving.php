        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <section class="content">
                            <form id="inbound-form" action="<?php echo base_url("admin/reportinglist/C_moving/export"); ?>" method="post">
                                <div class="box box-solid box-info">
                                    <div class="card card-info">
                                        <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-list"></i> MOVING INFORMATION</h3>
                                        </div>
                                    </div>
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label for="Reporting_moving_code">MOVING CODE</label>
                                                <input class="form-control" size="60" maxlength="200" placeholder="MOVING CODE" name="moving_code" id="Reporting_moving_code" type="text" />
                                            </div>
                                            <div class="form-group col-md-6">
