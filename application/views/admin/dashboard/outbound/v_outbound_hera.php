                            ...
                            <div class="col-md-14">
                                <div class="card card-info shadow-sm">
                                    <div class="card-header">
                                        ...
                                        <button type="button" id="reload1" onclick="indoMallSummary()" class="btn btn-tool" data-card-widget="card-refresh" data-source="<?php echo base_url() ?>admin/outbound/C_outbound_hera" data-source-selector="#card-refresh-content" data-load-on-init="false">
                            ...
                            <div class="col-md-14">
                                <div class="card card-info shadow-sm">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                        <button type="button" id="reload2" onclick="indoMallPerDay()" class="btn btn-tool" data-card-widget="card-refresh" data-source="<?php echo base_url() ?>admin/outbound/C_outbound_hera" data-source-selector="#card-refresh-content" data-load-on-init="false">
                                            <i class="fas fa-sync-alt"></i>
                                        </button>
                            ...
                            <div class="col-md-14">
                                <div class="card card-info shadow-sm">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                        <button type="button" id="reload3" onclick="heraSummary()" class="btn btn-tool" data-card-widget="card-refresh" data-source="<?php echo base_url() ?>admin/outbound/C_outbound_hera" data-source-selector="#card-refresh-content" data-load-on-init="false">
                                            <i class="fas fa-sync-alt"></i>
                                        </button>
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i>
                                        </button>
                            ...
                            <div class="col-md-14">
                                <div class="card card-info shadow-sm">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                        <button type="button" id="reload4" onclick="heraPerDay()" class="btn btn-tool" data-card-widget="card-refresh" data-source="<?php echo base_url() ?>admin/outbound/C_outbound_hera" data-source-selector="#card-refresh-content" data-load-on-init="false">
                                            <i class="fas fa-sync-alt"></i>
                                        </button>
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i>
                                        </button>
...
<script type="text/javascript">
    ...
    function indoMallSummary() 
    {
        ...
        var uri = '<?php echo base_url(); ?>admin/outbound/C_outbound_hera/getIndoMallSum';
    ...
    function indoMallPerDay() 
    {
        ...
        var uri = '<?php echo base_url(); ?>admin/outbound/C_outbound_hera/getIndoMallDay';
    ...
    function heraSummary() 
    {
        ...
        var uri = '<?php echo base_url(); ?>admin/outbound/C_outbound_hera/getHeraSum';
    ...
    function heraPerDay() 
    {
        ...
        var uri = '<?php echo base_url(); ?>admin/outbound/C_outbound_hera/getHeraDay';
