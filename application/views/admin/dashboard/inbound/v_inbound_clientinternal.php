                            ...
                            <div class="col-md-14">
                                <div class="card card-info shadow-sm">
                                    <div class="card-header">
                                        ...
                                        <button type="button" onclick="topClientSummary()" class="btn btn-tool" data-card-widget="card-refresh" data-source="<?php echo base_url() ?>admin/inbound/C_inbound_clientinternal" data-source-selector="#card-refresh-content" data-load-on-init="false">
                            ...
                            <div class="col-md-14">
                                <div class="card card-info shadow-sm">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                        <button type="button" id="reload2" onclick="topClientPerDay()" class="btn btn-tool" data-card-widget="card-refresh" data-source="<?php echo base_url() ?>admin/inbound/C_inbound_clientinternal" data-source-selector="#card-refresh-content" data-load-on-init="false">
                                            <i class="fas fa-sync-alt"></i>
                                        </button>
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i>
                                        </button>
...
<script type="text/javascript">
    ...
    function topClientSummary() 
    {
        ...
        var uri = '<?php echo base_url(); ?>admin/inbound/C_inbound_clientinternal/getAllslaTopClient';
    ...
    function topClientPerDay() 
    {
        ...
        var uri = '<?php echo base_url(); ?>admin/inbound/C_inbound_clientinternal/getAllslaDayTopClient';
