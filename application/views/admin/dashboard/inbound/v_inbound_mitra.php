                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    <td>
                                        <form action="<?php echo base_url('admin/inbound/C_inbound_mitra') ?>">
                                            <!-- <button class="btn btn-block btn-outline-primary"><span class="glyphicon glyphicon-refresh"></span>Reload</button> -->
                                            <button type="button" id="reload" onclick="reloadMitra()" class="btn btn-block btn-outline-primary" data-card-widget="card-refresh" data-source="<?php echo base_url() ?>admin/inbound/C_inbound_mitra" data-source-selector="#card-refresh-content" data-load-on-init="false">
