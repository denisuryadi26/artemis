                        ...
                        <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                            <div class="col-md-14">
                                ...
                                <div class="card-header">
                                    ...
                                    <button type="button" id="reload" onclick="tokocabangSummary()" class="btn btn-tool" data-card-widget="card-refresh" data-source="<?php echo base_url() ?>admin/inbound/C_inbound_tokocabang" data-source-selector="#card-refresh-content" data-load-on-init="false">
                            ...
                            <div class="col-md-14">
                                <div class="card card-info shadow-sm">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                        <button type="button" id="reload2" onclick="tokocabangPerDay()" class="btn btn-tool" data-card-widget="card-refresh" data-source="<?php echo base_url() ?>admin/inbound/C_inbound_tokocabang" data-source-selector="#card-refresh-content" data-load-on-init="false">
                                            <i class="fas fa-sync-alt"></i>
                                        </button>
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-minus"></i>
...
<script type="text/javascript">
    ...
    function tokocabangSummary() 
    {
        ...
        var uri = '<?php echo base_url(); ?>admin/inbound/C_inbound_tokocabang/getAllslaTokocabang';
    ...
    function tokocabangPerDay() 
    {
        ...
        var uri = '<?php echo base_url(); ?>admin/inbound/C_inbound_tokocabang/getAllslaDayTokocabang';
